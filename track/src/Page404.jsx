...
export default function Page404() {
    ...
    return (
        <div
            className='flex flex-col items-center justify-center size-full h-[100vh]'
            style={{
                background: 'radial-gradient(circle, white 50%, gray 130%, black 100%)'
            }}
        >
            <div className='flex items-center gap-5 justify-center'>
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#555555" height="60px" width="60px" version="1.1" viewBox="0 0 54.971 54.971" xmlSpace="preserve">
                    <g>
                ...
                <h1 className='font-robotoSans text-[4rem]'>404</h1>
            </div>
            <h1 className='font-robotoSans'>Page was not found</h1>
        </div>
    )
}