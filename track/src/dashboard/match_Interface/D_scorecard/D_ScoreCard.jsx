...
export default function D_ScoreCard() {
    ...
    return (
        <div ref={divRef} className={`font-[100] outline-none ${theme ? 'text-[#3b3b3b]' : 'text-[#CCCCCC]'} p-3 w-full h-full overflow-auto ${theme ? '' : 'custom-scrollbar'}`}>
            <div className={`flex flex-col px-3 700:px-5 w-full border ${theme ? 'border-[#bbbbbb]' : 'border-[#999999]'} rounded-lg`}>
                <div className={`px-1 700:px-3 py-5 flex flex-col gap-y-1 border-b ${theme ? 'border-b-[#d8d8d8]' : 'border-b-[#3d3d3d]'}`}>
                ...
                <div className={`py-5 flex flex-col items-center w-full gap-x-5 border-b ${theme ? 'border-b-[#d8d8d8]' : 'border-b-[#3d3d3d]'}`}>
                    <div className={`my-2 p-3 px-0 700:px-3 flex flex-col justify-between w-full border ${theme ? 'border-[#bbbbbb]' : 'border-[#999999]'} rounded-md`}>
                            ...
                            {data.menOnStrike === 'double' ?
                                ...
                                <div className={`pb-3 flex justify-between font-bold`}>
                                    {(() => {
                                        ...
                                        return (
                                            <>
                                            <h1 className={`font-robotoSans ${theme ? 'text-black' : 'text-white'}`}>{`${retVal.name}*`}</h1>
                                            <h1 className={`font-robotoSans text-[#797979]`}>{`${retVal.runs}(${retVal.balls})`}</h1>
                                            </>
                                        )
                                    })()}
                                </div>
                                <div className={`w-full border-b ${theme ? 'border-b-[#d8d8d8]' : 'border-b-[#3d3d3d]'}`}></div>
                    ...
                    <div className={`text-[.8rem] 700:text-[1rem] my-2 p-3 700:px-6 flex justify-between w-full border ${theme ? 'border-[#bbbbbb]' : 'border-[#999999]'} rounded-md`}>
                        {(() => {
                            let retVal = null 
